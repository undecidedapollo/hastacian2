...
echo "Start 5 uninitialized distacean servers..."
...
nohup ./target/debug/distacean  --id 4 --http-addr 127.0.0.1:21004 > n4.log &
sleep 1
echo "Server 4 started"
sleep 1

nohup ./target/debug/distacean  --id 5 --http-addr 127.0.0.1:21005 > n5.log &
sleep 1
